...
FOR REPLICA ON
    N'sql-ag-0' WITH (
        ENDPOINT_URL = N'tcp://sql-ag-0.sql-ag.mssql.svc.cluster.local:5022',
    ...
    N'sql-ag-1' WITH (
        ENDPOINT_URL = N'tcp://sql-ag-1.sql-ag.mssql.svc.cluster.local:5022',
        AVAILABILITY_MODE = SYNCHRONOUS_COMMIT,
        FAILOVER_MODE = EXTERNAL,
        SEEDING_MODE = AUTOMATIC,
        SECONDARY_ROLE (ALLOW_CONNECTIONS = READ_ONLY)
    ...
    N'sql-ag-2' WITH (
        ENDPOINT_URL = N'tcp://sql-ag-2.sql-ag.mssql.svc.cluster.local:5022',
        AVAILABILITY_MODE = SYNCHRONOUS_COMMIT,
        FAILOVER_MODE = EXTERNAL,
        SEEDING_MODE = AUTOMATIC,
        SECONDARY_ROLE (ALLOW_CONNECTIONS = READ_ONLY)
